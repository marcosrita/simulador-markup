...
# A partir daqui vamos adicionar o conteúdo de cada página (Produtos, Custos, Simulador etc.)
# Mas antes de seguir, quer que eu inclua agora os formulários de cadastro (Produtos, Custos Variáveis, Custos Fixos) e a lógica do simulador?
import streamlit as st
import home
import pandas as pd
import plotly.express as px
